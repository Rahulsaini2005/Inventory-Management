...
# Add any paths that contain asdf here, relative to this directory.
...
# Custom sidebar asdf, maps document names to template names.
#html_sidebars = {}

# Additional asdf that should be rendered to pages, maps page names to
# template names.
