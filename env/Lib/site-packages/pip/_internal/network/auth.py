...
class MultiDomainBasicAuth(AuthBase):
    def __init__(
        ...
        # When the customer is prompted to enter credentials and keyring is
        # available, we will offer to save them. If the customer accepts,
    ...
    def _get_url_and_credentials(
        ...
        # This accounts for the situation in which the customer has specified
    ...
    def handle_401(self, resp: Response, **kwargs: Any) -> Response:
        ...
        # We are not able to prompt the customer so simply return the response
        ...
        # Prompt the customer for a new username and password
        save = False
        ...
        # keyring. (Note that if the customer responded "no" above, this member
